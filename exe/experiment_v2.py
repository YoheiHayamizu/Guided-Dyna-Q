...
if __name__ == "__main__":
    ...
    # RUN
    ###########################
    exe.exeutils.runs_episodes_w_switching(env, qlearning, step=opts.iters, episode=opts.episodes, seed=opts.seeds,
                                           s1=opts.start, g1=opts.goal, s2=opts.next_start, g2=opts.next_goal)
    exe.exeutils.runs_episodes_w_switching(env, dynaq, step=opts.iters, episode=opts.episodes, seed=opts.seeds,
                                           s1=opts.start, g1=opts.goal, s2=opts.next_start, g2=opts.next_goal)
    exe.exeutils.runs_episodes_w_switching(env, darling, step=opts.iters, episode=opts.episodes, seed=opts.seeds,
                                           s1=opts.start, g1=opts.goal, s2=opts.next_start, g2=opts.next_goal)
    exe.exeutils.runs_episodes_w_switching(env, gdq, step=opts.iters, episode=opts.episodes, seed=opts.seeds,
                                           s1=opts.start, g1=opts.goal, s2=opts.next_start, g2=opts.next_goal)
